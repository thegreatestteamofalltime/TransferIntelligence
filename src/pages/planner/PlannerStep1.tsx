      ...
      >
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Select your school, current degree, and program to get a personalized plan — based on the official{" "}
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card>
            <CardContent className="p-6 space-y-6">
              ...
              <div>
                <label className="text-sm font-semibold block mb-1">Target School</label>
                <p className="text-xs text-muted-foreground mb-2">
                  Select your transfer destination. More schools will be added over time.
                </p>
              ...
              <Button
                ...
                onClick={onNext}
                disabled={!currentDegreeId || !targetSchool}
              >
