    ...
    <div className="flex flex-col">
      ...
      <Alert className="mb-6 border-border bg-muted/40">
        ...
        <AlertDescription className="text-xs text-muted-foreground leading-relaxed">
          <strong>Heads up:</strong> TransferIntelligence is a hackathon prototype. For official guidance, always consult your institution's academic advising office directly.
        </AlertDescription>
      </Alert>
        </div>
      </section>
