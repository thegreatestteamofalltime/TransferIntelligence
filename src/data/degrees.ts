...
export const novaCSAssociate: DegreePlan = {
  ...
  requirements: [
    ...
    { code: "CSC 205", name: "Computer Organization", credits: 3, category: "core", year: "sophomore", notes: "Choose one: CSC 205, CSC 215, or MTH 265", isOption: true },
    { code: "CSC 208", name: "Introduction to Discrete Structures", credits: 3, category: "math", year: "sophomore", notes: "Choose one: CSC 208 or MTH 288", isOption: true },
    ...
    { code: "Hum/FA Elective 1", name: "Humanities/Fine Arts Elective (Area 1)", credits: 3, category: "general-ed", year: "freshman", notes: "6–8 credits required from two different areas: ART, Humanities, or Literature" },
    ...
    { code: "Soc/Beh Elective", name: "Social/Behavioral Sciences Elective", credits: 3, category: "general-ed", year: "sophomore", notes: "3 credits required — ADJ, ECO, GEO, PLS, PSY, or SOC courses" },
    { code: "Approved Elective", name: "Approved Elective", credits: 3, category: "elective", year: "sophomore", notes: "3–4 credits — CSC 195/215/295, EGR 121/122/270, CST 100/110, MTH 265/266/283, PHY 201, or science courses" },
  ],
}
