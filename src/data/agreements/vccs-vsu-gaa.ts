  ...
  sections: [
    {
      ...
      summary:
        "An agreement guaranteeing admission to VSU for students who earn a qualifying transfer associate degree and meet academic benchmarks. General admission under the GAA does not guarantee admission to a specific program.",
    },
    {
      id: "section-2",
    ...
    },
    {
      ...
      summary:
        "Completion of an AA, AS, or AA&S transfer degree satisfies all lower-division general education requirements at VSU. Additional courses may be required for any general education courses where a grade of D or F was earned.",
    },
    {
      id: "section-4",
      title: "Dual Enrollment Students",
      summary:
        "The GAA applies to students who earn an associate degree concurrently with a high school diploma through a dual enrollment program.",
    },
    {
      id: "section-5",
      title: "Credit for Prior Learning",
      summary:
        "Students who complete the associate degree using CLEP, IB, AP, or ACE/Joint Services credit are eligible for the GAA and receive its benefits upon transfer. Official transcripts must be sent to VSU.",
    },
    {
      id: "section-6",
      title: "Catalog Determination",
      summary:
        "VSU honors the catalog in effect at the time of the student's first post-high school enrollment at the VCCS institution. Students have up to four years from their first enrollment under continuous enrollment.",
    },
    {
      id: "section-7",
      title: "Transfer Guide",
      summary:
        "Major-specific transfer guides are developed and featured at the Transfer Virginia portal (transfervirginia.org). Students should check the Transfer Guidance section to understand whether university admission also guarantees program admission.",
    },
    {
      id: "section-8",
      title: "Administration of Agreement",
      summary:
        "Administered by the VSU Director of Transfer Student Services and the VCCS Senior Vice Chancellor for Academic and Workforce Programs. The agreement remains in effect until modified or terminated by either party with one year's written notice.",
    },
    {
      id: "section-9",
      title: "Review Clause",
      summary:
        "VSU and VCCS review this agreement and student tracking data every three years to maintain integrity and improve the transfer process. Changes are not applied retroactively.",
    },
  ],
...
export function getAgreementForSchools(
  ...
  return ALL_AGREEMENTS.find((a) => {
    const targetMatch = a.targetInstitution.toLowerCase().includes(targetLower) ||
...
export function isVCCSInstitution(schoolName: string): boolean {
  ...
  return vccsSchools.some((s) => lower.includes(s))
}
